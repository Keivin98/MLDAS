<section id="intro">
  <div class="intro-container wow fadeIn">
    ...
    <div class="about-content mt-5"
         style="background: rgba(255, 255, 255, 0.45); padding: 30px; border-radius: 8px; text-align: left; box-sizing: border-box;">
      <div class="row">
        <div class="col-lg-12">
          <!-- <h2 class="mb-4 pb-0"><span>About The Symposium</span></h2> -->
          <p
             style="color: rgba(255, 255, 255, 0.9); line-height: 1.5; margin-bottom: 0; font-size: 1.1rem;font-weight: 500">
            {!! $settings[ 'about_description' ] ?? '' !!}</p>
        </div>
        <div class="col-lg-3">
